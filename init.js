...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'MdadeLe';
const subSiteKeywords = `smart video editing, smart video editor, smart ai video tools` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = '45df0495b31f4a7a86e793abaca4583a'; // 替换为你的API密钥
